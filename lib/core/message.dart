class Message {
  ...
  Message(
      {required this.message, this.type = MessageType.error, this.extraInfo});

  Message.error(this.message, {this.extraInfo}) : this.type = MessageType.error;
  Message.warning(this.message, {this.extraInfo})
      : this.type = MessageType.warning;
  Message.success(this.message, {this.extraInfo})
